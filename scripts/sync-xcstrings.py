...
TRANSLATIONS = {
    ...
    "Aucune notification à prévisualiser": "Nothing to preview",
    "Mets l'app en arrière-plan dans les 5 secondes pour la voir.": "Background the app within 5 seconds to see it.",
    "Aucune carte due dans les 30 prochains jours.": "No cards due in the next 30 days.",
    "Réglages": "Settings",
